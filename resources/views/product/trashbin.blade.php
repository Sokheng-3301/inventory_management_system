...
@section('title')
    <title> {{ __('nav.trashbin')}} | IMS</title>
@endsection
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">{{ __('nav.trashbin')}}</h3>
                        <h6 class="font-weight-normal mb-0">{{ __('nav.product') }} / <span class="text-primary"><a
                                    class="text-primary" href="">{{ __('nav.trashbin')}}</a></span></h6>
                    </div>
                </div>
                <div class="row mt-4">
                                    ...
                                    @if ($checkRole->role_name == 'admin' || $checkRole->role_name == 'Admin' || $action->action_edit == 1)
                                        <div class="col-8 col-sm-7 mb-2  col-md-7">
                                            <div class="ui small icon buttons">
                                                ...
                                                <a href="{{ route('product.exportTrashbinExcel') }}" class="ui button fw-normal"
                                                    title="Excel"><i class="file excel icon"></i>Excel</a>
                                                <a href="{{ route('product.exportTrashbinPdf') }}"
                                            ...
                                            @foreach ($products as $key => $item)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <p><span class="text-danger">Code :</span> {{ $item->item_code }}
                                                        </p>
                                                        <p><span class="text-danger">Name :</span>
                                                            {{ $item->item_name_kh . ' - ' . $item->item_name_en }}</p>
                                                        <p><span class="text-danger">Cate :</span> {{ $item->cat_name }}</p>
                                                        <p><span class="text-danger">Type :</span>
                                                    ...
                                                    <td class="text {{ $item->delete_status == '0' ? 'text-danger' : '' }}">
                                                        <p><span>By : </span>{{ strtoupper($item->delete_by) }}</p>
                                                        <p><span>Deleted : </span>{{ Carbon\Carbon::parse($item->delete_date)->format('d M Y') }}</p>
                                                        <p><span>Added : </span>{{ Carbon\Carbon::parse($item->create_date)->format('d M Y') }}</p>
                                                    </td>
