                                    ...
                                    @if ($checkRole->role_name == 'admin' || $checkRole->role_name == 'Admin' || $action->action_edit == 1)
                                        <div class="col-8 col-sm-7 mb-2  col-md-7">
                                            <div class="ui small icon buttons">
                                                ...
                                                <a href="{{ route('product.givenExport', request()->all()) }}" class="ui button fw-normal"
                                                    title="Excel"><i class="file excel icon"></i>Excel</a>
                                                <a href="{{ route('productGiven.pdf', request()->all()) }}" class="ui button fw-normal"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text">
                                                        ...
                                                        @foreach ($explodeProductId as $id => $proID)
                                                            ...
                                                            @if($givenPro->serial_number )
                                                                <p class="ps-4"><span class="text-muted">SN.</span> {{$givenPro->serial_number}}</p>
                                                            @endif
                                                            @if($givenPro->fix_asset_code )
                                                                <p class="ps-4"><span class="text-muted">FAC.</span> {{$givenPro->fix_asset_code}}</p>
                                                            @endif
                                                            @if($givenPro->model )
                                                                <p class="ps-4"><span class="text-muted">Mod.</span> {{$givenPro->model}}</p>
                                                            @endif
                                                            {{-- @if($givenPro->pro_description )
                                                                <p class="ps-4"><span class="text-muted">Note.</span> {{$givenPro->pro_description}}</p>
                                                            @endif --}}
                                                        @endforeach
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @if ($checkRole->role_name == 'admin' || $checkRole->role_name == 'Admin' || $checkRole->role_name == 'Super Admin' || $action->action_edit == 1)
                                                            | <a href="{{ route('product.returnDetail', $item->giveId) }}"
