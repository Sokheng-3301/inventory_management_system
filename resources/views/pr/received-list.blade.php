...
@section('title')
<title> {{__('nav.receivedProdcut')}} | IMS</title>
@endsection
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">{{__('nav.receivedProdcut')}} </h3>
                    <h6 class="font-weight-normal mb-0">{{__('nav.productPurchase')}}  / <span class="text-primary"><a class="text-primary"
                                href="">{{__('nav.receivedProdcut')}} </a></span></h6>
                </div>
                                        ...
                                        @foreach ($purchasings as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (($checkRole->role_name == 'admin' || $checkRole->role_name == 'Admin') || $action->action_edit == 1)
                                                        @if ($item->add_stock_status == 0)
                                                        | <a href="{{route('purchase.addStock', $item->purchase_id)}}"><span class="mdi mdi-store-plus-outline fs-5 text-success" title="Add stock"></span></a>
                                                        @else
                                                        <span class="badge badge-info">{{__('nav.Instock')}}</span>
                                                        @endif
                                                    ...
                                                    <div class="col-sm-12 col-md-5 mb-3 mx-auto">
                                                        <div class="bg-light p-3">
                                                            ...
                                                            <div class="row mt-4">
                                                                ...
                                                                <div class="col-4">
                                                                    <label for="">{{__('nav.receivedDate')}}</label>
                                                                </div>
                                                                <div class="col-8">
                                                                    <span class="pe-3">:</span>
                                                                    {{$item->receive_date}}
