                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($product as $item)
                                                <tr>
                                                        ...
                                                        @if ($item->return_status == 1)
                                                            ...
                                                            @foreach ($productReturnedIds as $proID)
                                                                ...
                                                                <p><span class="text-danger">{{ $incre++ }}.</span>
                                                                    {{ $givenPro->pro_name_en }}
                                                                    {{ $givenPro->pro_name_kh ? ' - ' . $givenPro->pro_name_kh : '' }}
                                                                </p>
                                                            ...
                                                            @endforeach
                                                        @else
                                                            @foreach ($productGivenAlls as $proID)
                                                                @php
                                                                    $givenPro = DB::table('products')
                                                                        ->where('id', $proID)
                                                                        ->get()
                                                    ...
                                                    <td class="text">
                                                        <p class="text-uppercase"><span class="text-muted text-capitalize">Given By : </span>{{ $item->add_by }}</p>
