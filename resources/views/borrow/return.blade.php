                                        ...
                                        @foreach ($return as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="<?php
                                                    ...
                                                    ?>"><span class="badge badge-info">{{$item -> payback_date}}</span>
                                                </td>
                                                <td class="<?php
                                                        if($item->delete_status == '0'){
                                                            echo 'text-danger';
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="updateForm{{$item->borrow_id}}"><span class="mdi mdi-book-open"></span> Borrow detail</h1>
                                                                    ...
                                                                    <div class="col-sm-12 col-md-8">
                                                                        <div class="bg-light p-3">
                                                                            ...
                                                                            <div class="row d-flex align-items-center mt-2">
                                                                                ...
                                                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                                                    <p class="text-danger fw-bold">{{$item->borrow_qty}}</p>
                                            ...
                                            <div class="modal fade" id="recoveryCategory{{$item->borrow_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="recoveryCategory{{$item->borrow_id}}Label" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="recoveryCategory{{$item->borrow_id}}">Product return verify</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form action="{{route('product.return')}}" method="post" autocomplete="off">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label for="">{{ __('nav.userReturnProductQuestion') }}-primary fw-bold">{{$item->pro_name_en}}</span> ?</label>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit" class="ui button primary">
                                                                    <span class="mdi mdi-eye-check-outline"></span> Yes
                                                                </button>
                                                            </div>
                                                        </form>
    ...
    <script>
        $(document).ready(function() {
            $('#export-btn').click(function() {
                ...
                XLSX.writeFile(wb, "borrow-return-list.xlsx");
            });
        });
    </script>
    <script>
