...
@section('title')
<title> {{__('nav.overdrafts')}} | IMS</title>
@endsection
                                ...
                                <table id="departmentTb" class="display table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{__('nav.borrower')}}</th>
                                            <th>{{__('home.qty')}}</th>
                                            <th>{{__('nav.borrowDate')}}</th>
                                            <th>{{__('nav.returnDate')}}</th>
                                            <th>{{__('nav.returned')}}</th>
                                        ...
                                        @foreach ($overdraft as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="<?php
                                                    ...
                                                    ?> text-danger">{{$item -> pro_code}}
                                                </td>
                                                <td class="<?php
                                                        if($item->delete_status == '0'){
                                                            echo 'text-danger';
                                                        }
                                                    ?> text-danger">{{$item -> pro_name_en}}
                                                </td>
                                                ...
                                                <td class="<?php
                                                    ...
                                                    ?> text-danger">{{$item -> borrow_date}}
                                                </td>
                                                <td class="<?php
                                                        if($item->delete_status == '0'){
                                                            echo 'text-danger';
                                                        }
                                                    ?> text-danger">{{$item -> payback_date}}
                                                </td>
                                                <td class="<?php
                                                        if($item->delete_status == '0'){
                                                            echo 'text-danger';
                                                        }
                                                    ?> text-danger"> <span class="badge badge-danger">
                                                        <span class="mdi mdi-alpha-x-circle-outline"></span> {{__('nav.overdrafts')}}</span>
                                                </td>
                                            ...
                                            <div class="modal fade" id="recoveryCategory{{$item->borrow_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="recoveryCategory{{$item->borrow_id}}Label" aria-hidden="true">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="recoveryCategory{{$item->borrow_id}}">{{__('nav.productReturnTitle')}}</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#export-btn').click(function() {
                ...
                XLSX.writeFile(wb, "overdraft.xlsx");
            });
        });
    </script>
    <script>
