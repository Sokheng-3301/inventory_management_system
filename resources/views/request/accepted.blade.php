...
@section('title')
<title>{{__('nav.Accepted')}} | IMS</title>
@endsection
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">{{__('nav.Accepted')}}</h3>
                    <h6 class="font-weight-normal mb-0">{{__('nav.RequestAndBorrow')}} / <span class="text-primary"><a class="text-primary"
                                href="">{{__('nav.Accepted')}}</a></span></h6>
                </div>
                                ...
                                <table id="departmentTb" class="display table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{__('nav.approveBy')}}</th>
                                            <th>{{__('nav.approveAt')}}</th>
                                        ...
                                        @foreach ($accepted as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    | <a type="button" data-bs-toggle="modal" data-bs-target="#borrowReturn{{$item->borrow_id}}" ><span class="mdi mdi-inbox-arrow-down-outline fs-5 text-success" title="Borrow return"></span></a>
                                                    @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12 col-md-8">
                                                                        <div class="bg-light p-3">
                                                                            ...
                                                                            <div class="row d-flex align-items-center mt-2">
                                                                                <div class="col-sm-12 col-md-3 col-l-3">
                                                                                    <label for="qty" class="fw-bold">{{__('nav.borrowQty')}} </label>
                                                                                </div>
                                                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                                            ...
                                                                            <div class="row d-flex align-items-center mt-2">
                                                                                <div class="col-sm-12 col-md-3 col-l-3">
                                                                                    <label for="descript" class="fw-bold">{{__('nav.borrowPurpose')}} <span class="text-danger"></span></label>
                                                                                </div>
                                                                                <div class="col-sm-12 col-md-9 col-l-9">
                                            ...
                                            <!-- Modal recovery-->
                                            <div class="modal fade" id="borrowReturn{{$item->borrow_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="borrowReturn{{$item->borrow_id}}Label" aria-hidden="true">
                                                
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="borrowReturn{{$item->borrow_id}}">{{__('nav.productReturnTitle')}}</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form action="{{route('product.return')}}" method="post" autocomplete="off">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" class="ui button green">
                                                                    <span class="mdi mdi-eye-check-outline"></span> {{__('nav.yes')}}
                                                                </button>
                                                            </div>
                                                        </form>
