...
@section('title')
<title>{{__('nav.requestHistory')}} | IMS</title>
@endsection
                                ...
                                <table id="departmentTb" class="display table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{__('nav.requestStatus')}}</th>
                                            <th>{{__('nav.returnStatus')}}</th>
                                        ...
                                        @foreach ($history as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="<?php
                                                    ...
                                                    ?>">
                                                        @if ($item->borrow_status == 0)
                                                            <span class="badge badge-warning"><span class="mdi mdi-chat-processing-outline"></span> Pending</span>
                                                        @elseif ($item->borrow_status == 1)
                                                            <span class="badge badge-success"><span class="mdi mdi-check-circle-outline"></span> Accepted</span>
                                                        @else
                                                            <span class="badge badge-danger"><span class="mdi mdi-alpha-x-circle-outline"></span> Rejected</span>
                                                        @endif
                                                </td>
                                                @if ($item->borrow_status == 1)
                                                    <td class="<?php
                                                        ...
                                                        ?>">
                                                            @if ($item->payback_status == 0)
                                                                <span class="badge badge-success"><span class="mdi mdi-clipboard-arrow-down-outline"></span> Returned</span>
                                                            @elseif ($item->payback_status == 1)
                                                                <span class="badge badge-warning"><span class="mdi mdi-hand-coin-outline"></span> In hand</span>
                                                            @else
                                                                <span class="badge badge-danger"><span class="mdi mdi-alpha-x-circle-outline"></span> Overdraft</span>
                                                            @endif
                                                    </td>
                                                @else
                                                    <td>
                                            ...
                                            <div class="modal fade" id="recoveryCategory{{$item->borrow_id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="recoveryCategory{{$item->borrow_id}}Label" aria-hidden="true">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="recoveryCategory{{$item->borrow_id}}">Accept reqest</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form action="{{route('request.accept')}}" method="post" autocomplete="off">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label for="">Do you want to accept request from <span class="text-primary fw-bold">{{$item->name_en}}</span> ?</label>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-primary btn-sm">
                                                                    <span class="mdi mdi-email-check-outline"></span> Yes
                                                                </button>
                                                            </div>
                                                        </form>
