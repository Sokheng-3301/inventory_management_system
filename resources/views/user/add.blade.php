        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold"> {{__('nav.addNew')}} {{$name}}</h3>
                    <h6 class="font-weight-normal mb-0"> {{__('nav.manageUser')}} / <span class="text-primary"><a class="text-primary"
                                href=""> {{__('nav.addUser')}}</a> </span></h6>
                </div>
            </div>
            <div class="row mt-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-4 ">
                                        <div class="bg-light p-3">
                                            ...
                                            <small class="text-center d-block">{{__('home.userProfile')}}.</small>
                                        ...
                                        <div class="bg-light p-3">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="text" class="form-control" id="name_kh" name="name_kh" placeholder="{{__('nav.fullNameKh')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="text" class="form-control" id="name_en" name="name_en" placeholder="{{__('nav.fullNameEn')}}">
                                                </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="text" class="form-control" id="cardId" name="cardId" placeholder="{{__('nav.staffId')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    ...
                                                    <select name="gender" id="gender" class="ui search dropdown d-block w-100">
                                                        ...
                                                        <option value="Female">{{__('nav.female')}}</option>
                                                        <option value="Male">{{__('nav.male')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <select name="position" id="position" class="ui search dropdown1 d-block w-100">
                                                        ...
                                                        @foreach ($position as $c)
                                                            <option value="{{$c->id}}">{{ $c->position_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="text" class="form-control" id="username" placeholder="{{__('nav.username')}}" name="username">
                                                </div>
                                            </div>

                                            <div class="row d-flex align-items-center mt-3">
                                                <div class="col-sm-12 col-md-3 col-l-3">
                                                    <label for="password"> {{__('nav.password')}} <span class="text-danger"></span></label>
                                                </div>
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="password" id="password" class="form-control" placeholder=" {{__('nav.password')}}" name="password">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                <div class="col-sm-12 col-md-3 col-l-3">
                                                    <label for="confirmPassword"> {{__('nav.confirmPass')}} <span class="text-danger"></span></label>
                                                </div>
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="password" id="confirmPassword" class="form-control" placeholder=" {{__('nav.confirmPass')}}" name="confirmPassword">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    ...
                                                    <input disabled type="text" id="roleName" class="form-control" placeholder="Role name" value="{{$name}}">
                                                    <input type="hidden" name="roleId" class="d-none" style="display: none;" value="{{$id}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="tel" id="phoneNumber" class="form-control" placeholder="{{__('nav.phoneNumber')}}" name="phoneNumber">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex align-items-center mt-3">
                                                ...
                                                <div class="col-sm-12 col-md-9 col-l-9">
                                                    <input type="email" id="emailAddress" class="form-control" placeholder="{{__('nav.emailAddress')}}" name="email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12 d-flex justify-content-end align-items-end">
                                                    <button type="submit" class="ui button tiny primary" style="width: fit-content;"><span class="mdi mdi-check-circle icon"></span>  {{__('nav.save')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@if (session() -> has('duplicate'))
    <script>
       const Toast = Swal.mixin({
                    ...
                    Toast.fire({
                    icon: "error",
                    title: "ID card has existed already."
                    });
    </script>
@endif
@if (session() -> has('duplicate'))
    <script>
       const Toast = Swal.mixin({
                    ...
                    Toast.fire({
                    icon: "error",
                    title: "Email has existed alredy."
                    });
    </script>
@endif
